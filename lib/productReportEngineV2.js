import { getProductContent } from '../data/productContentLibraryV2';
...
// Backwards-compat aliases for proposalModelV2.js / api routes
export const buildProductReportNode = buildProductNode;
export const buildProductReportNodes = buildProductNodes;
