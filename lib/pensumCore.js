...
export function beregnAllokering(likvid, pe, eiendom, profilNavn, rater) {
  ...
  if (total === 0) {
    return [
      { navn: 'Globale Aksjer', vekt: 0, avkastning: r.globaleAksjer, kategori: 'aksjer' },
      { navn: 'Norske Aksjer', vekt: 0, avkastning: r.norskeAksjer, kategori: 'aksjer' },
      { navn: 'Høyrente', vekt: 0, avkastning: r.hoyrente, kategori: 'renter' },
      { navn: 'Investment Grade', vekt: 0, avkastning: r.investmentGrade, kategori: 'renter' },
      { navn: 'Private Equity', vekt: 0, avkastning: r.privateEquity, kategori: 'privateMarkets' },
      { navn: 'Eiendom', vekt: 0, avkastning: r.eiendom, kategori: 'eiendom' }
    ];
  }
...
export const RAPPORT_DATO = '30.04.2026';
...
export const RAPPORT_MAANED = '2026-04';
export const RAPPORT_DATO_ISO = '2026-04-30';
...
export const HISTORIKK_2026_YTD = {
  'global-core-active': -2.9,
  'global-edge': -4.4,
  'basis': -2.1,
  'global-hoyrente': 1.1,
  'nordisk-hoyrente': 1.8,
  'norge-a': 9.5,
  'energy-a': 28.6,
  'banking-d': 2.8,
  'financial-d': 1.0,
  'kairos-a': null,
  'acadian-global-equity': 10.2,
  'capital-group-new-pers': 2.2,
  'dnb-global-enhanced': -2.0,
  'guinness-global-equity-income': 5.3,
  'janus-henderson-glb-sc': 8.4
};
