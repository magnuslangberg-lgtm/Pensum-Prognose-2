import { DATAFEED_RAPPORT_DATO } from '../data/pensumDatafeedHistorikk';
import { RAPPORTERT_YTD } from '../data/pensumReportedPerformance';
...
export const RAPPORT_DATO = DATAFEED_RAPPORT_DATO.split('-').reverse().join('.');
export const HISTORIKK_ARFELT = ['aar2026', 'aar2025', 'aar2024', 'aar2023', 'aar2022'];

export function beregnProduktNokkeltall(produkt) {
  // Ekskluder inneværende YTD — bruk kun hele kalenderår i 3-års beregning
...
// Bakoverkompatibelt navn. Nye konsumenter bør bruke RAPPORTERT_YTD direkte.
export const HISTORIKK_2026_YTD = RAPPORTERT_YTD;
