...
export const CATEGORY_COLORS = { aksjer: '#0D2841', renter: '#C4967E', privateMarkets: '#2D6A6A', eiendom: '#A67B3D' };
export const ASSET_COLORS = { 'Globale Aksjer': '#6B9DB8', 'Norske Aksjer': '#0D2841', 'Høyrente': '#C4967E', 'Investment Grade': '#D4B8A8', 'Private Equity': '#2D6A6A', 'Eiendom': '#A67B3D' };
export const ASSET_COLORS_LIGHT = { 'Globale Aksjer': '#A8C8D8', 'Norske Aksjer': '#6B9DB8', 'Høyrente': '#DCCABE', 'Investment Grade': '#E8D8CE', 'Private Equity': '#7AADAD', 'Eiendom': '#D4B888' };
